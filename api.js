...
const path = require("path") //untuk memanggil path direktory
...
app.post("/barang", upload.single("image"), (req, res) => {
    ...
    if(!req.file) {
        ...
        db.query(sql, data, (error, result) => {
            ...
            res.json({
                message: result.affectedRows + " data berhasil di simpan"
            })
        })
    }
})
...
app.put("/barang", upload.single("image"), (req, res) => {
    ...
    if(!req.file) {
        // jika tidak ada file yang dikirimkan = update data saja
        data = {
            nama_barang: req.body.nama_barang,
            harga: req.body.harga,
            stok: req.body.stok,
        ...
        // jika mengirim file = upload data + reupload
        data = {
            nama_barang: req.body.nama_barang,
            harga: req.body.harga,
            stok: req.body.stok,
        ...
        // get data yang akan diupdate utuk mendapatkan nama file yang lama
    ...
    db.query(sql, [data, param], (error, result) => {
        if(error) {
            ...
            res.json({
                message: result.affectedRows + " data berhasil di ubah"
            })
        }
    })
})
